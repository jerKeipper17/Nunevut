...
public class EquipmentCreator extends BasicGameState{
    
    private int stateID;
    
        //Buttons
    public ButtonImage exitBtn, upBtn, leftBtn, downBtn, rightBtn;
    public ButtonImage acceptBtn, loadFormBtn;
    ...
    String exitLoad;
    public int acceptX1, acceptX2, acceptY1, acceptY2, loadFormX1, loadFormX2, loadFormY1, loadFormY2;
    String acceptLoad, loadFormLoad;
    ...
    public EquipmentCreator(int state){
        stateID = state;
        ...
        loadFormX1 = 960/5 + 117; loadFormX2 = 960/5 - 117; 
        loadFormY1 = 736 - 50 + 32; loadFormY2 = 736 - 50 - 32;
        loadFormLoad = "/res/images/Tiles/Menu/LoadFormBtnA.png";
    }
    ...
    public void init(GameContainer container, StateBasedGame game) throws SlickException {
        ...
        loadFormBtn = new ButtonImage(loadFormX1, loadFormY1, loadFormX2, loadFormY2, loadFormLoad, 468, 150, 0, 0, Color.white);
        ...
        //Welcome Message
        String insText = "WELCOME TO THE BLACKSMITH! CREATE ITEMS HERE!";
    ...
    public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
        ...
        loadFormBtn.render(container, game, g);
    }
    ...
    public void update(GameContainer container, StateBasedGame game, int delta) throws SlickException {
        ...
        loadFormBtn.update(container, game, delta);
        ...
        if (acceptBtn.checkHover((int) mouseX, (int) mouseY)) {
            ...
            if (Mouse.isButtonDown(0)) { //Enter item into database
                ...
                try {
                    ...
                    String SQL = "INSERT INTO weapons VALUES ('" + itemNameBox.getUserString() + "','" + viewImage.getLoad() + "'," + 24 + "," + 24 + ","
                            + imageXBox.getUserStringInt() + "," + imageYBox.getUserStringInt() + "," + rBox.getUserStringInt() + "," + gBox.getUserStringInt() + "," + bBox.getUserStringInt() + "," + alphaBox.getUserStringInt() + ","
        ...
        if (loadFormBtn.checkHover((int) mouseX, (int) mouseY)) {
            loadFormLoad = "/res/images/Tiles/Menu/LoadFormBtnB.png";
