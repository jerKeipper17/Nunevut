...
public class Map001 extends MapObject{
    ...
    public Map001(int stateID, String type, String name, MapManager mapM) throws SQLException, ClassNotFoundException {
    ...
    public void init(GameContainer container, StateBasedGame game) throws SlickException {
        ...
        getWarpManager().addToWarpListAt(new Warp(16, 656, true, 1, 0, 0), 0);
        getWarpManager().addToWarpListAt(new Warp(928, 32, true, 3, 2, 1), 1);
    ...
    public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
        ...
        //warp01.render(container, game, g);
        g.setColor(Color.cyan);
        //warp02.render(container, game, g);
